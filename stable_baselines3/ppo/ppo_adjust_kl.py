...
class PPOAdjustKL(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        super(PPOAdjustKL, self).__init__(
            policy,
            env,
    ...
    def _setup_model(self) -> None:
        super(PPOAdjustKL, self)._setup_model()
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                loss = policy_loss + self.ent_coef * entropy_loss + self.vf_coef * value_loss + self.beta * kl_loss
            ...
            if(mean_kl<self.kl_threshold/1.5):
                ...
                logger.log(f"Mean KL Divergence: {mean_kl}, No Change on Beta")
    ...
    def learn(
        ...
        tb_log_name: str = "PPOAdjustKL",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> "PPOAdjustKL":

        return super(PPOAdjustKL, self).learn(
